draw2d.End=function(_url){
	draw2d.ResizeImage.call(this, '结束', _url);
...
draw2d.End.prototype.setEventName = function(_eventName) {
...
draw2d.End.prototype.onDoubleClick=function(event){
	var tid = this.getId();
	if(typeof openNodeProperties != "undefined"){
		openNodeProperties(tid);
		return false;
...
draw2d.End.prototype.toWFLWDI=function(){
	var w=this.getWidth();
