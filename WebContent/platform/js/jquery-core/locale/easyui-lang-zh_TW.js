...
if ($.fn.validatebox){
	$.fn.validatebox.defaults.missingMessage = '此項為必輸項';
...
if ($.fn.numberbox){
	$.fn.numberbox.defaults.missingMessage = '此項為必輸項';
}
if ($.fn.combobox){
	$.fn.combobox.defaults.missingMessage = '此項為必輸項';
}
if ($.fn.combotree){
	$.fn.combotree.defaults.missingMessage = '此項為必輸項';
}
if ($.fn.combogrid){
	$.fn.combogrid.defaults.missingMessage = '此項為必輸項';
}
if ($.fn.calendar){
...
if ($.fn.datebox){
	...
	$.fn.datebox.defaults.missingMessage = '此項為必輸項';
}
