...
public class ImpExcelPaccyPriDataAction extends EAPAction{
            ...
            while (rows.hasNext()) {
                ...
                while (cells.hasNext()) {
                    ...
                    if("".equals(cellVal.replaceAll(" ", ""))){            
                    	...
                    	key = "PACCYPRI_curSign";
                   }
                    }
                    else if(colIdx == 1){//汇买价
                       
                    	key = "PACCYPRI_buyPrice";
                   
                    }else if(colIdx == 2){//钞买价
                    
                    	key = "PACCYPRI_billbuyPrice";
                    }else if(colIdx == 3){//汇卖价
                    
                    	key = "PACCYPRI_salePrice";
                    }else if(colIdx == 4){//钞卖价
                    	
                    	key = "PACCYPRI_billsalePrice";
                    }else if(colIdx == 5){//中间价
                    	
                    	key = "PACCYPRI_middlePrice";
                    }else if(colIdx == 6){//生效日期
                    	
                    	key = "PACCYPRI_impDate";
	                }else if(colIdx == 7){//生效时间
	                	
	                	key = "PACCYPRI_impDatetime";
		            }
