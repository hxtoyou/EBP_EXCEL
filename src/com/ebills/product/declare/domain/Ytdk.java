...
/**
 * 外债银团贷款—签约信息 SbYtdk entity. @twteam 对应表名：SB_YTDK
 */

public class Ytdk extends Entity {
	...
	public Ytdk() {
		...
		this.setCreditorca(new BigDecimal(0));
